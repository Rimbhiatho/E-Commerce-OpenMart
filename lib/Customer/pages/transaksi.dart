            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isIncome =
                    ...
                    transaction.type.contains('income');
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              '${isIncome ? '+' : '-'}Rp ${transaction.amount.toStringAsFixed(2)}',
                              style: TextStyle(
                                fontSize: 16,
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  'Rp ${transaction.balanceBefore.toStringAsFixed(2)}',
                                  style: const TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w600,
                                  ),
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  'Rp ${transaction.balanceAfter.toStringAsFixed(2)}',
                                  style: const TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w600,
                                    color: Colors.green,
